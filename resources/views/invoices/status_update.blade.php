...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoices.status_update', $invoice->id) }}" method="post" autocomplete="off">
                        @csrf
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section" class="form-control SlectBox" readonly disabled>
                                    <option value="{{ $invoice->section->section_name }}">
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control" readonly disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rate_vat" id="Rate_VAT" class="form-control" readonly disabled>
                                    <!--placeholder-->
