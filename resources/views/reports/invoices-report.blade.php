...
@section('page-header')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تقارير الفواتير</h4>
            ...
            <div class="rcard-header d-flex align-items-center justify-content-between flex-wrap" style="gap:10px; padding:16px 22px; background:#fff; border-bottom:1px solid #f0f4f8;">
                ...
                <div class="d-flex align-items-center flex-wrap" style="gap:8px;">
                    <h5 class="rcard-title">
                        <i class="fas fa-file-invoice text-primary ml-1"></i>
                        تفاصيل الفواتير
                    </h5>
                    <span class="count-badge">{{ $invoices->count() }} فاتورة</span>
                ...
                <div class="filter-panel">
                    <form method="GET" action="{{ route('reports.invoices') }}" id="filterForm">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 mb-3">
                                ...
                                <select id="status" name="status" class="form-control">
                                    ...
                                    <option value="1" {{ ($filters['status'] ?? '') == '1' ? 'selected' : '' }}>مدفوعة</option>
                                    <option value="2" {{ ($filters['status'] ?? '') == '2' ? 'selected' : '' }}>غير مدفوعة</option>
                                    <option value="3" {{ ($filters['status'] ?? '') == '3' ? 'selected' : '' }}>مدفوعة جزئياً</option>
                                </select>
                            </div>
                            <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <div class="filter-footer">
                            ...
                            <a href="{{ route('reports.invoices') }}" class="tbtn tbtn-reset">
